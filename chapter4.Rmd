...
Here is the first set of k-means clustering done with four clusters. For easier inspection, I only plotted tohe pairs of firts six variables in the data set.
